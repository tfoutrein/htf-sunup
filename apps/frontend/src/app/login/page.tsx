        ...
        <Card className="bg-white/20 backdrop-blur-md shadow-2xl border border-white/30 shadow-orange-500/20">
          <CardBody className="p-6 sm:p-8">
            ...
            <div className="text-center mb-6 sm:mb-8">
              {logoChoice === 'sun' ? (
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-orange-400 to-amber-400 rounded-full flex items-center justify-center mx-auto mb-4 animate-pulse">
