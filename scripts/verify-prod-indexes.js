...
const PROD_DB_URL = 'postgresql://htf_sunup_postgres_user:NxW7QrfoU2l7Lry090Q69gj8qDkgFny0@dpg-d1b8fsadbo4c73c9ier0-a.oregon-postgres.render.com/htf_sunup_postgres';
...
async function verifyIndexes() {
  ...
  try {
    ...
    console.log(`📋 Indexes attendus (migration 0011): ${EXPECTED_INDEXES.length}\n`);
